...
[![Existing System Topology](/img/caci/02-solution-topology.png)](/img/02-solution-topology.png)
...
## Security
The solution had end-to-end encryption over the wire, appropriately restrictive TLS and cipher suite configuration for each ingress point, and a WAF solution at the edge.
